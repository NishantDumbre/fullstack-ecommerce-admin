...
const ProductDisplaySection = () => {
  ...
  return (
    <div
    className={`h-72 w-screen flex justify-around items-center my-20 ${theme.primaryBg} `}
    >
      <div
        className={`w-5/12 h-full border ${theme.border} ${theme.secondaryBg}`}
      >
        <h1 className={`text-lg font-semibold text-center pt-5`}>
          Add/edit categories
        </h1>
